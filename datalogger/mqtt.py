...
class Mqtt:
	...
	def __init__(
		self,broker_url: str, client_id: str, connect_async: bool = False, mqtt_logging: bool = False
	) -> None:
		...
		self.client._transport = environ.get("MQTT_TRANSPORT", "tcp").lower()
		self.client._protocol = environ.get("MQTT_PROTOCOL_VERSION", MQTTv311)
	...
	def on_publish(self, handler: Callable) -> Callable:
		"""Decorator.
	...
	def on_log(self, handler: Callable) -> Callable:
